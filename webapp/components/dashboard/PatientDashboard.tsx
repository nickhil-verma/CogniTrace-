    ...
    <div className="space-y-8 max-w-4xl mx-auto animate-in fade-in duration-300">
      ...
      <Card className="p-8 bg-gradient-to-r from-[#E36C59] via-[#C85C82] to-[#17665B] text-white rounded-3xl shadow-lg relative overflow-hidden">
        <div className="space-y-3 relative z-10">
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-md px-4 py-1.5 rounded-full text-xs font-bold">
            ...
            <span>Patient Daily Companion</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">
            Good day! How are you feeling today?
          </h1>
          <p className="text-base text-white/90 font-medium">
            I am here to help you remember your daily tasks, talk through cherished memories, or answer any questions.
          </p>
        </div>
      </Card>
      ...
      <Card className="p-8 text-center bg-white border-2 border-[#BFDCD6] rounded-3xl shadow-md space-y-6">
        <div className="space-y-2">
          <h2 className="text-2xl font-extrabold text-[#123B35]">Talk with your Voice AI Assistant</h2>
          <p className="text-sm text-[#66736F]">Tap the button below and speak naturally</p>
        </div>
        ...
        <Card className="p-6 space-y-4 bg-white border border-[#DDE7E3] rounded-3xl">
          <div className="flex items-center justify-between border-b border-[#DDE7E3] pb-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-lg font-bold text-[#123B35]">Today’s Simple Checklist</h3>
            </div>
        ...
        <Card className="p-6 space-y-4 bg-white border border-[#DDE7E3] rounded-3xl">
          <div className="flex items-center justify-between border-b border-[#DDE7E3] pb-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-lg font-bold text-[#123B35]">My Photo Album</h3>
            </div>
          ...
          {memories.length > 0 ? (
            <div className="space-y-3">
              ...
              >
                ...
                <span>Talk about this photo with AI</span>
              </Link>
            </div>
          ) : (
            <p className="text-xs text-[#66736F]">No photos in memory album yet.</p>
          )}
        </Card>
      </div>
      ...
      <Card className="p-6 bg-red-50 border-2 border-red-200 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="space-y-1 text-center sm:text-left">
          <h3 className="text-lg font-extrabold text-red-900">Need Immediate Help?</h3>
          <p className="text-xs text-red-700">Tap below to call your primary caregiver immediately.</p>
        </div>
        <a
          href="tel:911"
